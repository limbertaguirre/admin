...
BEGIN TRY
 ...
 ------------------------------------------------------------------ 
   ...
   SET @ID_ESTADO_COMISION_PAGO_COMISION_CERRADO = 17; -- PAGO COMISION REZAGADO CERRADO
   ...
   SET @ID_ESTADO_COMISION_16_PARA_HABILITAR = 0
      ...
      SET @ID_ESTADO_COMISION_16_PARA_HABILITAR = ISNULL((SELECT cec.id_comision_estado_comision_i FROM BDMultinivel.DBO.GP_COMISION C 
	   ...
	   BEGIN	   
        ...
        COMMIT TRANSACTION;	
		  ...
		  BEGIN
            ...
            BEGIN
              UPDATE BDMultinivel.dbo.GP_COMISION_ESTADO_COMISION_I set habilitado=@ESTADO_HABILITADO where id_comision_estado_comision_i = @ID_ESTADO_COMISION_16_PARA_HABILITAR
            END
        COMMIT TRANSACTION;		
		    RETURN 2
