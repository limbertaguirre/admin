...
SET @IDESTADOCOMISION_ACTUAL = 0;
  ...
  where c.id_comision = @comision_id and c.id_ciclo = @ID_CICLO_VAR and c.id_tipo_comision = @ID_TIPO_COMISION_PAGOCOMISION and cec.habilitado = @ESTADO_HABILITADO and cec.id_estado_comision = @ID_ESTADO_COMISION_FORMA_DE_PAGO;
