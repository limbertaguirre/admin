...
-- VARIABLES PARA EMAIL
    ...
    SET @cantidadRezagados = (select COUNT(i.id_lista_formas_pago) from BDMultinivel.dbo.vwObtenerRezagadosPagos i
                            ...
                            select * from BDMultinivel.dbo.GP_COMISION c where c.id_ciclo = 84
                            select * from BDMultinivel.dbo.vwObtenerInfoExcelFormatoBanco i where i.id_ciclo = 84 and i.id_empresa = 3

                            select * from BDMultinivel.dbo.vwObtenerEmpresasComisionesDetalleEmpresa o
                            where o.id_ciclo = 84 and o.id_tipo_comision = 1 and o.id_tipo_pago = 2 and o.monto_transferir <> 0 and o.id_estado_comision = 10
