                    ...
                    {stableSort(
                      ...
                      .map((row, index) => (
                        ...
                        >
                          ...
                          <TableCell align="center">
                            {row.pagoDetalleHabilitado == true &&
                            row.idEstadoListadoFormaPago ==
                              utilidad.ID_ESTADO_LISTADO_FORMA_PAGO ? (
                              <Chip
                                label="Pagado"
                                color="primary"
                                variant="outlined"
                              ...
                              <>
                                ...
                                {row.idEstadoListadoFormaPago ==
                                  utilidad.ID_ESTADO_LISTADO_FORMA_PAGO_RECHAZADO && (
                                  <Chip
                                    label="Rechazado"
                                    color="secondary"
                                    variant="outlined"
