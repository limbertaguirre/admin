...
const PagosTransferenciaDetalleDialog = ({
  ...
  return (
    ...
    >
      {isConfirm ? (
        <DialogTitle className={style.dialgoTitle}>
          Confirmar transferencia
        </DialogTitle>
      ) : (
        <DialogTitle className={style.dialgoTitle}>
          Detalle de pago por transferencias
        </DialogTitle>
      )}
                ...
                <Grid item xs={6} sm={6}>
                  <div className={style.listItemDiv}>
                    <Typography
                      ...
                      gutterBottom
                    >
                      Cantidad de ACI enviados:
                    </Typography>
                    <Tooltip
                      title={cantidadEnviadosText}
                      PopperProps={{ style: { fontSize: "14px" } }}
                      arrow={true}
                      placement="top"
                      enterTouchDelay={10}
                ...
                <Grid item xs={6} sm={6}>
                  <div className={style.listItemDiv}>
                    <Typography
                      ...
                      gutterBottom
                    >
                      Total confirmados (ACI):
                    </Typography>
                    <Tooltip
                      title={cantidadConfirmadosText}
                      PopperProps={{ style: { fontSize: "14px" } }}
                      arrow={true}
                      placement="top"
                      enterTouchDelay={10}
                ...
                <Grid item xs={6} sm={6}>
                  <div className={style.listItemDiv}>
                    <Typography
                      ...
                      gutterBottom
                    >
                      Total rechazados (ACI):
                    </Typography>
                    <Tooltip
                      title={cantidadRechazadosText}
                      PopperProps={{ style: { fontSize: "14px" } }}
                      arrow={true}
                      placement="top"
                      enterTouchDelay={10}
                ...
                <Grid item xs={6} sm={6}>
                  <div className={style.listItemDiv}>
                    <Typography
                      ...
                      gutterBottom
                    >
                      Monto confirmados ($us.):
                    </Typography>
                    <Tooltip
                      title={montoConfirmadosText}
                      PopperProps={{ style: { fontSize: "14px" } }}
                      arrow={true}
                      placement="top"
                      enterTouchDelay={10}
                  ...
                  <ListItem className={style.item} alignItems="flex-start">
                    ...
                    >
                      <Typography
                        ...
                        gutterBottom
                      >
                        Total pendientes (ACI):
                      </Typography>
                      <Tooltip
                        title={totalPendientesText}
                        PopperProps={{ style: { fontSize: "14px" } }}
                        arrow={true}
                        placement="top"
                        enterTouchDelay={10}
                  ...
                  <ListItem className={style.item}>
                    ...
                    >
                      <Typography
                        ...
                        gutterBottom
                      >
                        Monto total pendientes ($us.):
                      </Typography>
                      <Tooltip
                        title={montoTotalPendientesText}
                        PopperProps={{ style: { fontSize: "14px" } }}
                        arrow={true}
                        placement="top"
                        enterTouchDelay={10}
      ...
      <DialogActions>
        {isConfirm && (
          <Button
            ...
            onClick={() => handleConfirm(userName, empresaId)}
          >
            Confirmar transferencia
          </Button>
        )}
        <Button className={style.dialogConfirmButton} onClick={() => close()}>
          Cerrar
        </Button>
      </DialogActions>
    </Dialog>
