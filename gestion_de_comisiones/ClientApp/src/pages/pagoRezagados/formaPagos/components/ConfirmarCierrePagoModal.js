            ...
            {habilitado && (
              <div>
                <ul>
                  {listadoSeleccionado.map((valu, index) => (
                    <li key={index}>
                      {" "}
                      <b>
                        {valu.nombre.toUpperCase()} {valu.cantidad}{" "}
                      </b>{" "}
                      ACI{" "}
                    </li>
                  ))}
                ...
                <Typography variant="caption" display="block" gutterBottom>
                  <strong>NOTA :</strong>{" "}
                  {"¿Está seguro de que desea cerrar la planilla?"}
                </Typography>
              </div>
            )}
          </Alert>
                        ...
                        <Grid item xs={12} sm container>
                          ...
                          >
                            <Grid item xs>
                              <Typography gutterBottom variant="subtitle1">
                                <b>
                                  {valu.area.toUpperCase()} {" ("}{" "}
                                  {valu.cantidadHabilitados} {" Personas "}{" "}
                                  {valu.cantidadConfigMinima} {"  )"}{" "}
                                </b>
                              </Typography>
