...
import {TextField, Button, Dialog , DialogActions , DialogContent ,
  DialogTitle , Slide , Typography , Grid} from '@material-ui/core';
...
const ModalResumenPlanilla = (props) => {
    ...
    <div>
      ...
      >
        ...
        <DialogActions>
          ...
          <Button onClick={clickBotonAceptar} variant="contained" color="primary">Confirmar carga de planilla</Button>
        </DialogActions>
      </Dialog>
    </div>
  );
...
export default ModalResumenPlanilla