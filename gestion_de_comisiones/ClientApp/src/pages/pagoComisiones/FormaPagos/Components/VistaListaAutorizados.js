...
const VistaListaAutorizados = (props) => {
  ...
  return (
    <>
        ...
        >            
            <DialogContent>
                    <div className={objList.comisionAutorizada?classes.rootTituloConfir: classes.rootTituloPendi}>    
                        <Typography variant="subtitle1" className={classes.Titulo} gutterBottom>
                        {objList.comisionAutorizada?<b>CONFIRMADO</b> :<b>PENDIENTE A CONFIRMACION</b> }
                        </Typography>                                                                                              
                    </div> 
                    <div>
                        ...
                        <div className={classes.divRadio}>
                            <List className={classes.rootList}>
                                {objList.autorizadores.map((valu, index) => (
                                   <ListItem key={index}>                                        
                                        <ListItemText primary={valu.nombre.toUpperCase() +' '+ valu.apellido.toUpperCase()} secondary={valu.area} />
                                        <ListItemAvatar>
